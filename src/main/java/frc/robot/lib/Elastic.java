...
/**
 * ElasticLib - utility for sending popup notifications and switching tabs on the Elastic Dashboard.
 *
 * <p>Droped-in from https://github.com/Gold872/elastic-dashboard with package adjusted to
 * frc.robot.lib.
 */
